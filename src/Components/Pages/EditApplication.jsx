...
export default function EditApplication() {
    ...
    const { jobtitle, role, company, status, appliedon, referral, referralperson, description, wheredidyoufind, username, password } = applicationdata;
    ...
    const postData = async (e) =>{
        ...
        await axios.put(`http://localhost:8080/applications/updateapplication/${id}`,applicationdata);
        navigate("/");
    }
...
{/* Added username, password description and job source */}
...
<div className='form-group mb-3'>
                        <label htmlFor='jobboard'>Where Did I found this job</label>
                        <select 
